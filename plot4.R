...
par(mfrow=c(2,2))
with(d, {
    with(d,plot(d$Time,d$Global_active_power,type = 'l',xlab = " ",ylab = "Global Active Power"))
    with(d,plot(d$Time,d$Voltage,type = 'l',xlab = "datetime",ylab = "Voltage"))
    ...
    with(d,plot(d$Time,Global_reactive_power,type = 'l',xlab = "datetime"))
})
